    ...
    public function adminReport(){
        ...
        if($rows){
            ...
            if($rows[$x]->status=="Unresolved"){
                ...
                <input type="hidden" name="id" value="'.$rows[$x]->id.'">
                <button type="submit" id="adminDeact"><i class="fas fa-check-circle"></i> RESOLVE</button>
                <style>
                #adminDeact{color: white;background-color: teal;border: none;width: 85%;height: 30px;font-family: body;font-weight: bold;font-size: 15px;cursor: pointer;border-radius: 10px;
                ...
                <input type="hidden" name="id" value="'.$rows[$x]->id.'">
                <button type="submit" id="adminUserResolved"><i class="fas fa-times-circle"></i> UNRESOLVE</button>
                <style>
                #adminUserResolved{color: white;background-color: red;border: none;width: 85%;height: 30px;font-family: body;font-weight: bold;font-size: 15px;cursor: pointer;border-radius: 10px;
                    
                }

                #adminUserResolved:hover{
                    color: red;
                    background-color: white;
                }
