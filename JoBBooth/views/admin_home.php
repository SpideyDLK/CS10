...
<canvas id="myChart" width="16" height="11" ></canvas>
...
<script>
        var tableContainer = $(".adminReportTable");

        $( document ).ready(function() {
            $.get("../controllers/searchDataController.php?q=adminReport", {}).done(function(data){
