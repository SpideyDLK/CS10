...
<body class="viewAd">
    ...
    <div class="viewCandContainer"> 
        ...
        <div class="col2-viewAd">
            ...
            <div class="recViewCandAdd">Address Line 1,<br>Address Line 2,<br>Street Name,<br>City.<p id="address-viewCand"></p></div>
            </fieldset>
        ...
        <div class="col3-viewAd">
            ...
            <div  id="lvlEdu-viewCand">Bachelor's Degree</div>
            </fieldset>
            <div class="recViewCandButtonsRow1">
                <button class="recViewCandButtons" onclick="document.location='schedule_int_rec.php'">SCHEDULE INTERVIEW</button>
                <button class="recViewCandButtons" type="submit">RATE</button>
            </div>
            <div class="recViewCandButtonsRow1">
                <button class="recViewCandButtons" type="submit">ADD TO LIST</button>
                <button class="recViewCandButtonsred" type="submit">REMOVE FROM LIST</button>
            </div>
