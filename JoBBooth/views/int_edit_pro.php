        ...
        <div class="candProfileEditContainer">
            ...
            <form action="#">
                <fieldset>
                    ...
                    <label for="nic">Name<span class="reqStar">*</span></label>
                    <input id="nic" name="nic" type="text" value="Full Name"  required>

                    <label for="nic">NIC<span class="reqStar">*</span></label>
                    <input id="nic" name="nic" type="text" value="480220115V"  required>
