        ...
        <div class="candProfileEditContainer">
            ...
            <form action="#">
                <fieldset>
                    ...
                    <label for="nic">Agency Name<span class="reqStar">*</span></label>
                    <input id="nic" name="nic" type="text" value="Agency Name"  required>

                    <label for="nic">Agency Reg. No.<span class="reqStar">*</span></label>
                    <input id="nic" name="nic" type="text" value="ABC54321"  required>
