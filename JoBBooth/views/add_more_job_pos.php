...
<body class="compProfile">
      <div class="logoBack">
        ...
        <div class="compProfileH"><h>Add Interested Job Positions</h></div>
        <div class="compProfileContainer" id="compProfileContainer">
            <form action="../controllers/userController.php" method="post">
                <input type="hidden" name="type" value="addJobPos">
                <label for="jobPos">Interested Job Positions<span class="reqStar">*</span></label>
