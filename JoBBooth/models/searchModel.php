...
class searchModel{
   ...
   public function searchVacancy($term){
    ...
    public function isRescheduled($refNo){
        $this->DB->sql('SELECT * FROM interview_reschedule WHERE ref_no = :refNo');
        $this->DB->bind(':refNo',$refNo);
    ...
    public function reschReq($refNo){
        $this->DB->sql('SELECT * FROM interview_reschedule WHERE ref_no = :refNo');
        $this->DB->bind(':refNo',$refNo);
    ...
    public function viewIntsCand($uname){
        $this->DB->sql('SELECT * FROM interview_schedule_view WHERE cand_username = :candUname ORDER BY date');
    ...
    public function candDashboard($jobTitle,$uName){
        $this->DB->sql('SELECT * FROM candview WHERE cand_username = :uName AND jobPos LIKE :job_title');
    ...
    public function viewAllAds(){
        $this->DB->sql('SELECT * FROM vacancyview');
